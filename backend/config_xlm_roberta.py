...
# Get the directory where this config file is located (backend folder)
BACKEND_DIR = os.path.dirname(os.path.abspath(__file__))

# Model Configuration
MODEL_NAME = "xlm-roberta-base"
MODEL_SAVE_PATH = os.path.join(BACKEND_DIR, "outputs_xlm_roberta", "model")
RESULTS_SAVE_PATH = os.path.join(BACKEND_DIR, "outputs_xlm_roberta", "results")

# Service Configuration
ROBERTA_BACKEND_PORT = 8002

# Data Configuration
TRAIN_FILE = os.path.join(BACKEND_DIR, "datsets", "SOLD_train_cleaned.json")
TEST_FILE = os.path.join(BACKEND_DIR, "datsets", "SOLD_test_cleaned.json")
HATE_DICT_FILE = os.path.join(BACKEND_DIR, "datsets", "only_hate.csv")

# Feedback Configuration
FEEDBACK_DIR = os.path.join(BACKEND_DIR, "feedback")
FEEDBACK_CSV = os.path.join(FEEDBACK_DIR, "user_flags.csv")
RETRAIN_OUTPUT_BASE = os.path.join(BACKEND_DIR, "outputs_xlm_roberta", "fine_tuned")
